...
import { tools, getToolBySlug, getAllSlugs } from "@/lib/tools-data";
        ...
        <section className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {tool.tags.map((tag) => (
              <span
                key={tag}
                className="px-3 py-1 text-xs font-mono rounded-full bg-zinc-900 text-zinc-500 border border-zinc-800 hover:border-zinc-600 hover:text-zinc-300 transition-colors"
              >
                {tag}
              </span>
            ))}
